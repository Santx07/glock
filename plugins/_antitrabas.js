/**
𝙂𝙇𝙊𝘾𝙆 𝙗𝙤𝙩 @snowserpent._ - _antitrabas.js
...
export async function before(m, { conn, isAdmin, isBotAdmin, usedPrefix }) {
  ...
  const fakemek = { 'key': { 'participant': '0@s.whatsapp.net', 'remoteJid': '0@s.whatsapp.net' }, 'message': { 'groupInviteMessage': { 'groupJid': '573246448227-1616969743@g.us', 'inviteCode': 'm', 'groupName': 'P', 'caption': '𝙂𝙇𝙊𝘾𝙆 𝙗𝙤𝙩', 'jpegThumbnail': null } } };
