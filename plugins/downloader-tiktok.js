...
import {tiktokdl} from '@snowserpent._';
...
import('@xct007/frieren-scraper')
  ...
  .catch((error) => {
    console.error('SIGUEME AL INSTAGRAM @snowserpent._".');
  });
...
const handler = async (m, {conn, text, args, usedPrefix, command}) => {
  ...
  try {
    ...
    const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: texto, contextInfo: {externalAdReply: {title: 'ᴛʜᴇ ᴍʏsᴛɪᴄ - ʙᴏᴛ', body: null, thumbnail: imagen1, sourceUrl: 'https://github.com/Santx07/glock'}, mentionedJid: [m.sender]}}}, aa);
